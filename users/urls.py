...
from users.views import (CustomLoginView, CustomPasswordResetConfirmView, CustomPasswordResetView,
                         ResetPasswordCompleteView, UserDetailView, UserRegisterView, UserUpdateView)
