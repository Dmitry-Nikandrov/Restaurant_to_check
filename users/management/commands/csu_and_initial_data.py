...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        table1 = Table.objects.create(
            number= 1,
            seats=5,
            restaurant=rest_table
        )
        table1.save()
        self.stdout.write(self.style.SUCCESS(f'Ресторан "{table1.restaurant}" создан столик: {table1.number}'))
        ...
        table1.save()
        self.stdout.write(self.style.SUCCESS(f'Ресторан "{table2.restaurant}" создан столик: {table2.number}'))